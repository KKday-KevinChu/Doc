$(function() {
    //vip 提示 lightbox
    //在頁面停留 1分鐘才執行
    window.setTimeout('showvipMsg()', 60*1000); //進站 1分鐘才顯示
    showvipMsg = function showfixedtop() {
        if ($.cookie("vip_msg") != 1) {
            var content = '<div id="form_popUp" class="c-popUp--md">' +
            ...
            $.fancybox.open({
                ...
                afterClose: function () {
                    ...
                    document.cookie = "vip_msg=" + 1 + ";expires=" + d.toUTCString() + ";domain=.mobile01.com;samesite=Strict;";

                    if (typeof(gtag) == 'function') {
                        gtag('event', 'Vip_lightbox', {
                            'send_to': 'G-WDCDQVB1NT',
                ...
                afterShow: function() {
                    $('#btn-open').click(function() {
                        window.location.href='vipapply.php';
                        //Cookie紀錄1天後過期
